...
### Why assign a ForkVersion

To all intents and purposes, BPO forks are hardforks. They introduce backwards-incompatible consensus changes; it's just that their path to deployment is significantly simplified. At the protocol level, 
